...
using TreinamentoCotin.Api;
using TreinamentoCotin.ClassesEMetodos;
using TreinamentoCotin.Colecoes;
using TreinamentoCotin.EstruturasDeControle;
using TreinamentoCotin.Excecoes;
using TreinamentoCotin.Fundamentos;
using TreinamentoCotin.MetodosEFuncoes;
using TreinamentoCotin.OO;
using TreinamentoCotin.TopicosAvancados;
...
namespace TreinamentoCotin
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var opcao = new Exercicios(new Dictionary<string, Action>() {
                // Fundamentos
                ...
                { "NorthWind - Coleções", ColecoesNorthWind.Executar},
